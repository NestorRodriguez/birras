...
module.exports = (sequelize, DataTypes) => sequelize.define('tarjeta_credito', {
    id_tarjeta_credito: {
    ...
    Cuotas: {
        ...
        validate: {
            notNull: {
                msg: 'cuotas es requerido'
            },
            customValidator(value) {
                if (!value) {
                    throw new Error("cuotas no debe estar vacío");
                } else if (isNaN(value)) {
                    throw new Error("cuotas debe ser numérico");
                }
            }
        }
    }

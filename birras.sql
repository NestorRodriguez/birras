...
insert into  usuarios (nombre_usuario, contraseña, mail, id_roles) values ('Gnoveva','Bargnoveva','genoveva@gmail.com', 1);
...
INSERT INTO reserva(id_bares,Numero_personas,id_motivo,Dedicatoria,id_decorado,id_adicionales,Mesa,Nombre_festejado)
 VALUES(1,2,3,'disfrutalo',1,1,'mesa 1','alex');
INSERT INTO reserva(id_bares,Numero_personas,id_motivo,Dedicatoria,id_decorado,id_adicionales,Mesa,Nombre_festejado)
 VALUES(2,2,5,'gozalo',2,2,'mesa 2','santiago');
 select *from reserva; 
